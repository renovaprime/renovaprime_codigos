...
router.get(
  ...
  authMiddleware,
  permissionMiddleware('admin'),
  adminController.listAppointmentSpecialties
);

router.get(
  '/appointments/availability/specialty/:specialtyId/month/:yearMonth',
  authMiddleware,
  permissionMiddleware('admin'),
  adminController.getAppointmentMonthAvailability
);

router.get(
  '/appointments/availability/specialty/:specialtyId/day/:date',
  authMiddleware,
  permissionMiddleware('admin'),
  adminController.getAppointmentDaySlots
);
...
router.post(
  ...
  authMiddleware,
  permissionMiddleware('admin'),
  validate(createAdminAppointmentSchema),
...
router.post(
  '/doctors/:id/sync-memed',
  authMiddleware,
  permissionMiddleware('admin'),
  adminController.syncDoctorWithMemed
);
