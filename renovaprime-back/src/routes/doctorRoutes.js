...
router.get(
  ...
  permissionMiddleware('medico'),
  doctorApprovedMiddleware,
  doctorController.getMemedToken
);
...
// Patients with appointments route
router.get(
  '/patients-with-appointments',
  authMiddleware,
  permissionMiddleware('medico'),
  doctorApprovedMiddleware,
  doctorController.listPatientsWithAppointments
);

// Prescriptions by patient route
router.get(
  '/prescriptions/by-patient',
  authMiddleware,
  permissionMiddleware('medico'),
  doctorApprovedMiddleware,
  doctorController.listPrescriptionsByPatient
);
