        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
              {cms('final_cta_title', 'Comece agora com telemedicina de verdade')}
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              {cms('final_cta_subtitle', 'Tenha acesso a médicos especialistas, clínico geral 24h e muito mais. Sua saúde merece o melhor cuidado.')}
            </p>
