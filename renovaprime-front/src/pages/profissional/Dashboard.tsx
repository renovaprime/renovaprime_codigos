...
function StatCard({
  ...
  return (
    <Card className={`bg-gradient-to-br ${colorClasses[color].card} via-card/90 to-secondary/10 shadow-sm backdrop-blur-sm`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {type === 'current' && appointment.type === 'ONLINE' && appointment.teleconsultRoom && (
              <Button size="sm" onClick={() => navigate(`/profissional/consultas`)}>
                Acessar Consultas
              </Button>
            )}
          </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center text-center py-12">
              ...
              <Button
                variant="secondary"
                className="mt-4"
                onClick={() => navigate('/profissional/consultas')}
              >
                Ver Agenda
              </Button>
            </CardContent>
          ...
          <Card>
            <CardContent className="flex flex-col items-center text-center py-8">
              ...
              <p className="text-muted-foreground">
                Voce não tem consultas agendadas para hoje. Aproveite para revisar sua agenda ou verificar suas configurações.
              </p>
            </CardContent>
          </Card>
        )}
