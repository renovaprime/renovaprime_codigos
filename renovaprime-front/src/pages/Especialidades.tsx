          ...
          <div className="flex flex-col sm:flex-row gap-3 p-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10"
                value={searchTerm}
                data-cy="specialty-search-input"
            ...
            <EmptyState
              ...
              description={
                searchTerm
                  ...
                  : 'Adicione especialidades para categorizar os médicos da plataforma.'
              }
              action={
                !searchTerm ? (
                  ...
                  {filteredSpecialties.map((specialty) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <Badge variant={specialty.active ? 'success' : 'default'} data-cy="specialty-status-badge">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Switch
                            ...
                            data-cy="specialty-status-switch"
                          />
                          <button
                            onClick={() => handleDeleteClick(specialty)}
                            data-cy="delete-specialty-button"
