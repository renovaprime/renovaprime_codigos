...
import { salesReportService, type ResellerSaleRecord, type SalesSummary } from '../services/salesReportService';
import { branchService } from '../services/branchService';
import { resellerService } from '../services/resellerService';
import type { PartnerBranch, Reseller } from '../types/api';
  ...
  const loadSales = async () => {
    try {
      ...
      const [salesData, summaryData] = await Promise.all([
        salesReportService.getSales(filters),
        salesReportService.getSummary(filters),
      ]);
      ...
      <div className="space-y-6">
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-primary/10 via-card to-secondary/10 p-6 md:p-8">
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-sm text-muted-foreground md:text-base">Acompanhe as vendas realizadas por revendedores.</p>
          </div>
        </div>
