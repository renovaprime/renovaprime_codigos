      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-6 overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-primary/10 via-card to-secondary/10 p-6 md:p-8">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-display font-bold text-primary md:text-4xl">Consultas</h1>
            ...
            >
              Criar consulta para beneficiário
            </Button>
          </div>
        </div>
        ...
        <ConfirmModal
          ...
          description="Deseja cancelar esta consulta? Essa ação não pode ser desfeita."
