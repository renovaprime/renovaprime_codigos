...
import { UserPlus, Plus, Search, Edit2, Trash2, Link2 } from 'lucide-react';
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-primary/10 via-card to-secondary/10 p-6 md:p-8">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground md:text-base">Gerencie os revendedores das filiais.</p>
            </div>
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() => handleCopySalesLink(reseller)}
