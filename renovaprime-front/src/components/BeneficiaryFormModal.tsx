        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  data-cy="beneficiary-type-titular"
                />
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) => handleChange('type', e.target.value as BeneficiaryType)}
                  className="w-4 h-4 text-primary"
                  data-cy="beneficiary-type-dependente"
                />
          ...
          {formData.type === 'DEPENDENTE' && (
            <div>
              ...
              <select
                ...
                data-cy="beneficiary-titular-select"
                required
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-birth-date"
                required
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-phone"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-email"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-password"
                required={!isEditing}
              />
              {isEditing && (
            ...
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-password-confirmation"
                required={!isEditing}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                data-cy="beneficiary-form-state"
                className="w-full px-3 py-2 border border-border rounded-lg bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              >
            ...
            <div>
              ...
              <Input
                ...
                data-cy="beneficiary-form-address"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              data-cy="beneficiary-form-service-type"
              className="w-full px-3 py-2 border border-border rounded-lg bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              required
            >
          ...
          <div className="flex gap-3 pt-4 border-t border-border">
            <Button
              ...
              disabled={isLoading}
              className="flex-1"
              data-cy="beneficiary-form-cancel"
            >
              Cancelar
            </Button>
            <Button
              ...
              disabled={isLoading}
              className="flex-1"
              data-cy="beneficiary-form-submit"
            >
