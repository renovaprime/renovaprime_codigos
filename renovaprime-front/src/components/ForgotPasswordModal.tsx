...
export function ForgotPasswordModal({ isOpen, onClose }: ForgotPasswordModalProps) {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro ao enviar codigo. Tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro ao reenviar codigo. Tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="p-6">
            {success ? (
              ...
              <form onSubmit={handleResetPassword} className="space-y-6">
                <p className="text-muted-foreground">
                  Digite o código enviado para <span className="font-medium text-foreground">{email}</span> e sua nova senha.
                </p>
