...
interface DependenteFormModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function DependenteFormModal({ isOpen, onClose, beneficiary, isEditing = false }: DependenteFormModalProps) {
  ...
  const handleChange = (field: keyof BeneficiaryFormData, value: string | number) => {
